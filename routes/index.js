...
//       host: "nodestaging.a2zcreatorz.com",
//       port: 587,
//       secure: false,
//       requireTLS: true,
//       auth: {
...
//         <p>You are receiving this email because you (or someone else) have requested the reset of the password for your account.</p>
//         <p>Please click on the following link to reset your password:</p>
//         <p><a href="https://nodestaging.a2zcreatorz.com/nodeapp/resetPassword/${token}">Reset Password</a></p>
//         <p>Sincerely,</p>
//         <p>Bitdefender Team</p>`,
//     };
...
//   const { name, mobileNo, email } = req.body; // Get name, mobileNo, and email from the request body
...
//   }
// });
// // Add a new route for resetting password with old password check
// router.post("/resetPasswordWithCheck", async (req, res) => {
...
//     const oldPasswordMatch = await bcrypt.compare(oldPassword, user.hashedPassword);
//     if (!oldPasswordMatch) {
...
//   try {
//     const user = await User.findOne({ token });
//     console.log(token, 'checking token after web')
//     if (!user) {
//       return res
//         .status(404)
//         .json({ success: false, message: "Invalid or expired token" });
